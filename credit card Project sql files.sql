...
COPY cc_detail
FROM 'D:\ashrikha\OneDrive - George Mason University - O365 Production\Desktop\Fall 2024\Projects\Project BI\Credit Card Dashboards\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\ashrikha\OneDrive - George Mason University - O365 Production\Desktop\Fall 2024\Projects\Project BI\Credit Card Dashboards\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'D:\ashrikha\OneDrive - George Mason University - O365 Production\Desktop\Fall 2024\Projects\Project BI\Credit Card Dashboards\credit_card.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\ashrikha\OneDrive - George Mason University - O365 Production\Desktop\Fall 2024\Projects\Project BI\Credit Card Dashboards\customer.csv' 
DELIMITER ',' 
CSV HEADER;
